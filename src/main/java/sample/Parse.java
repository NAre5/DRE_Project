...
//        System.out.println(Arrays.toString(ans.toArray()));
    ...
    private static boolean isDoubleNumber(String str) {
        try {
    ...
    private String parsePrecent(String... str) {
        if (str[1].equals("%"))
            return str[0] + str[1];
        return str[0] + "%";
    }
    ...
    private static String cleanToken(String str) {
    ...
    public void run() {
        cDocument document;
        document = DocumentBuffer.getInstance().getBuffer().poll();
        parse(document.text);
        document.text = null;
